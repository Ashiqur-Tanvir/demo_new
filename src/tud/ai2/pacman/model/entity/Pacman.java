...
public class Pacman extends MovingEntity {
	...
	public Pacman(DataInputStream s) throws IOException {
		...
		this.speedUpStartTime = s.readLong();
		this.powerUpStartTime = s.readLong();
	...
	public void writeEntity(DataOutputStream s) throws IOException {
		...
		s.writeLong(this.speedUpStartTime);
		s.writeLong(this.powerUpStartTime);
	...
	/**
	 * @return minimale Zeit, bis ein Item auslaeuft. -1, falls nichts aktiv ist
	 */
	...
	/**
	 * {@inheritDoc} Deaktiviert Items, wenn diese abgelaufen sind.
	 */
